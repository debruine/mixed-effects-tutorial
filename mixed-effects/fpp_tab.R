...
fpp_tab <- tabItem(
  ...
  p("This simulation reports the proportion of runs that gave a significant effect of stimulus type (given the alpha you set). It will also report the false positive rate for the same simulations with the main effect of stimulus type set to 0. If you set the main effect of stimulus type to 0, then power will be equal to the false positive rate."),
  fluidRow(
    column(
      width = 2,
